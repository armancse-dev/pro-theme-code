...
function an_pro_code_file_calling(){
   ...
   wp_register_style( 'responsive', get_template_directory_uri().'/css/responsive.css', array(),'1.0.2','all' );
   ...
   wp_enqueue_script('slicknavjs', get_template_directory_uri().'/js/slicknav.js', array(), '1.0.1', 'true' );
